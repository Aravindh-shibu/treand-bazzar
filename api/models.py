...
class Product(models.Model):
    ...
    picture=models.ImageField(upload_to="images",default='default.jpeg',null=True)
...
class Basket(models.Model):
    ...
    @property
    def cart_items(self):
        # qs=Basket.objects.filter(Basket=self)
...
class BasketItem(models.Model):
    ...
    # # when adding the product to bascket the price total will automatically save
    # def save(self,*args,**kwargs):
    #     if not self.total:
    #         self.total=self.product.price*self.qty
    #     super().save(*args,**kwargs)

# when the profile_object is created then a basket will create
